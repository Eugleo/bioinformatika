...
◊box["AK s alifatickým postranním řetězcem"]{
    ◊definitions{
        ◊term["glycin"]{◊slide[27 #:inline #t #:s 1] často v kolagenu, často ve smyčkách, nejmenší a tedy dobře konzervovaný}
        ...
        ◊term["leucin"]{◊slide[36 #:inline #t #:s 1] součástí leucinového zipu při interakci proteinů s DNA}
    }
}

◊box["AK s kyselou (karboxylovou/amidovou) skupinou"]{
    ◊definitions{
        ◊term["asparagová kyselina"]{◊slide[29 #:inline #t #:s 1] bývá v aktivních místech enzymů}

        ◊term["asparagin"]{◊slide[39 #:inline #t #:s 1] první izolovaná AK (z chřestu, viz jméno), tvoří vodíkové můstky, účastní se cappingu (neutralizuje parciální náboj na N' koncích alfa helixů)}

        ◊term["glutamová kyselina"]{◊slide[31 #:inline #t #:s 1] může fungovat jako neurotransmiter, je podobná ASP}

        ◊term["glutamin"]{◊slide[41 #:inline #t #:s 1] je zdrojem energie pro mozek}
    }
}

◊box["AK se zásaditou (aminovou) skupinou"]{
    ◊definitions{
        ◊term["arginin"]{◊slide[42 #:inline #t #:s 1] může být methylován, bývá na povrchu, kvůli kladného náboje tvoří vodíkové můstky se záporně nabitými strukturami (DNA)}

        ◊term["lysin"]{◊slide[37 #:inline #t #:s 1] může být postrtranslačně modifikován}
    }
}

◊box["AK s aromatickým jádrem nebo hydroxylovou skupinou"]{
    ◊definitions{
        ◊term["histidin"]{◊slide[34 #:inline #t #:s 1] tvoří imidazol (další nukleotid, někdy součástí wobblingu), má neutrální pKa --- malá změna pH vede he změně náboje, takže je často používán jako vypínač závislý na pH, účastní se koordinace kovů}

        ◊term["fenyalanin"]{◊slide[32 #:inline #t #:s 1] je prekurzorem neurotransmiterů}

        ◊term["serin"]{◊slide[43 #:inline #t #:s 1] katalyzuje reakce (je to alkohol), především O-glykosylace a fosforylace, nervové plyny jej blokují v acetylcholinesteráze}

        ◊term["threonin"]{◊slide[44 #:inline #t #:s 1] má dva chirální atomy, taktéž účasten O-glykosylace a fosforylace (je to alkohol)}

        ◊term["tyrosin"]{◊slide[47 #:inline #t #:s 1] podobný PHE, prekurzor neurotransmiterů, účasten forsforylací (je to alkohol)}

        ◊term["tryptofan"]{◊slide[46 #:inline #t #:s 1] je největší a tedy dobře konzervovaný, účasten hydrofóbních interakcí (s cukry), prekurzor serotoninu a niacinu}
    }
}

◊box["AK se sírou v postranním řetězci"]{
    ◊definitions{
        ◊term["methionin"]{◊slide[38 #:inline #t #:s 1] má jen jeden kodon, může být na povrchu oxidován}

        ◊term["cystein"]{◊slide[30 #:inline #t #:s 1] často v hydrofobním jádře protein§ (přestože je polární), tvoří disulfidické můstky, iteraguje s ionty kovů (často v aktivních místech enzymů)}
    }
}
...
◊box["AK obsahující sekundární amin"]{
    ◊definitions{
        ◊term["prolin"]{
            ◊slide[40 #:inline #t #:s 1] nemá vodík na dusíku => netvoří vodíkové můstky, nebývá v alfa-helixech ani listech
