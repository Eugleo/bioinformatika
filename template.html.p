    ...
    <div class="sticky-header" id="sticky-header">
        <div class="wrapper">
            ...
            <span class="page-navigation">
                &lt;◊when/splice[show-prev]{
                    <a class="no-style" href=◊|previous-page| title="◊(select-from-metas 'title previous-page)">–</a>
                }◊when/splice[(and show-prev show-next)]{/}◊when/splice[show-next]{
                     <a class="no-style" href=◊|next-page| title="◊(select-from-metas 'title next-page)">+</a>
                }&gt;
            </span>
        </div>
    </div>
